...
declare module POGOProtos.Data.Player {
    ...
    export interface DailyBonus {
        next_collected_timestamp_ms: string;
        next_defender_bonus_collect_timestamp_ms: string;
    }
}
...
declare module POGOProtos.Data.Player {
    ...
    export interface EquippedBadge {
        badge_type: Enums.BadgeType;
        level: number;
        next_equip_change_allowed_timestamp_ms: string;
    }
}
...
declare module POGOProtos.Data.Player {
    ...
    export interface PlayerStats {
        ...
        pokemon_caught_by_type: any // unknown type
...
declare module POGOProtos.Data.Battle {
    ...
    export interface BattleAction {
        ...
        action_start_ms: string;
        duration_ms: number;
        energy_delta: number;
        attacker_index: number;
        target_index: number;
        active_pokemon_id: string;
        player_joined: BattleParticipant;
        battle_results: BattleResults;
        damage_windows_start_timestamp_mss: string;
        damage_windows_end_timestamp_mss: string;
...
declare module POGOProtos.Data.Battle {
    ...
    export interface BattleLog {
        ...
        battle_start_timestamp_ms: string;
        battle_end_timestamp_ms: string;
    }
}
...
declare module POGOProtos.Data.Battle {
    ...
    export interface BattleResults {
        ...
        next_defender_pokemon_id: string;
...
declare module POGOProtos.Inventory {
    ...
    export interface InventoryDelta {
        original_timestamp_ms: string;
        new_timestamp_ms: string;
...
declare module POGOProtos.Map.Fort {
    ...
    export interface FortData {
        id: string;
        last_modified_timestamp_ms: string;
        latitude: number;
        longitude: number;
        enabled: boolean;
        type: FortType;
        ...
        cooldown_complete_timestamp_ms: string;
        sponsor: FortSponsor;
        rendering_type: FortRenderingType;
        active_fort_modifier: any // unknown type
...
declare module POGOProtos.Map.Fort {
    ...
    export interface FortLureInfo {
        ...
        lure_expires_timestamp_ms: string;
    }
}
...
declare module POGOProtos.Networking.Requests {
    ...
    export interface Request {
        ...
        request_message: any // unknown type
    }
}
...
declare module POGOProtos.Networking.Requests.Messages {
    ...
    export interface StartGymBattleMessage {
        gym_id: string;
        attacking_pokemon_ids: string[];
        defending_pokemon_id: string;
        player_latitude: number;
        player_longitude: number;
    }
}
...
declare module POGOProtos.Networking.Envelopes {
    ...
    export interface AuthTicket {
        start: any // unknown type
        expire_timestamp_ms: string;
        end: any // unknown type
    }
}
...
declare module POGOProtos.Networking.Envelopes {
    ...
    export interface Signature {
        ...
        location_hash1: string;
        location_hash2: string;
        session_hash: any // unknown type
        timestamp: string;
        request_hash: string[];
        unknown25: string;
    }
...
declare module POGOProtos.Networking.Envelopes.Unknown6 {
    ...
    export interface Unknown2 {
        encrypted_signature: any // unknown type
    }
}
...
declare module POGOProtos.Networking.Responses {
    ...
    export interface DownloadRemoteConfigVersionResponse {
        ...
        item_templates_timestamp_ms: string;
        asset_digest_timestamp_ms: string;
    }
}
...
declare module POGOProtos.Settings.Master {
    ...
    export interface EquippedBadgeSettings {
        equip_badge_cooldown_ms: string;
...
declare module POGOProtos.Settings.Master {
    ...
    export interface IapSettings {
        ...
        min_time_between_claims_ms: string;
